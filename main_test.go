...
<p>I just landed in Seattle. It’s colder than expected. Like colder than it rightfully should be in any west coast city. Luckily, I learned from <a href="/nanoglyphs/033-heroku#new-york">my mistake in New York</a> and came equipped with a variety of cold weather gear this time around. I haven’t had a chance to do much yet besides check into my hotel and head over to the flagship Amazon Go store, which was quite busy, but appeared to be about 5% shoppers, and 95% senior Amazon staff chatting in small circles, lauding each other on their own ingenuity. Still, it was nice seeing a downtown that’d regained some of its lost vibrancy.</p>

<p>I got a coffee, along with a note saying that Amazon is “working on my receipt”, but nothing since. I suspect it might be a Mechanical Turk who ends up piecing together my bill from video rather than the finely tuned neural nets of a hyper-sophisticated ML cluster, but I might be a cynic. On my way out, someone handed me a free banana from a cart parked next to a geodesic dome.</p>

<p>Last weekend I wrote a <a href="https://github.com/brandur/spring83-keygen">Spring ‘83 key generator</a>, and on the flight got maybe halfway to a working server implementation. Tomorrow, more Seattle, more Spring ‘83, and work time spent on SSO and polish on a forthcoming metrics product for Bridge.</p>
